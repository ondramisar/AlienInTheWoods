...
public class Player1 extends Sprite{
    ...
    public Player1(PlayScreen screen){
        ...
        for(int i = 1; i < 4; i++)
            frames.add(new TextureRegion(screen.getAtlas2().findRegion("p2_spritesheet"), i * 71, 0, 70, 94));
        ...
        playerJump = new TextureRegion(screen.getAtlas2().findRegion("p2_spritesheet"), 423, 95, 66, 94);

        //create texture region for mario standing
        playerStand = new TextureRegion(screen.getAtlas2().findRegion("p2_spritesheet"), 67, 190, 66, 92);

        //create dead mario texture region
        playerDead = new TextureRegion(screen.getAtlas2().findRegion("p2_spritesheet"), 426, 0, 67 , 92);
    ...
    public void definePlayer(){
        ...
        fdef.filter.categoryBits = RunningGame.PLAYER_BIT1;
